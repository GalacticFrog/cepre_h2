 ...
 * @author jomaveger
 */
public class THPaginarAExamen extends SwingWorker<List<AsistenciaExamen>, Integer> {
    ...
    public THPaginarAExamen(AExamenTable tablaDatos, int pagina, /*JLabel lblPagina, */ JLabel lblTotal, ProgressGlassPane glassPane/*, Map<String, JButton> botones*/) {
    ...
    protected List<AsistenciaExamen> doInBackground() {
        ...
        this.total = total_;
        List<AsistenciaExamen> datas = aexDao.listar(pagina);
