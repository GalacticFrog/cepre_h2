...
//    private Fmd enrollmentFMD;
    ...
    public DLGEditar(Personal personal) {
        super(new java.awt.Frame(), true);
        initComponents();
        setPersonal(personal);
        setPersona(personal.getPersona());
        incializaTextos();
        cargarCombo();
        mostrar();
    ...
    private void mostrar() {
        ...
        Persona persona_ = personal_.getPersona();
        ...
        comboSede.setSelectedItem(personal_.getSede());
        comboCargo.setSelectedItem(personal_.getCargo());
    }
...
//        String _txtpass1 = String.copyValueOf(txtPass1.getPassword());
    ...
    private void guardarDocente() {
        try {
            ...
            Personal usuario_ = getPersonalDLG();
...
//        }
    ...
    /**
     * @param personal the docente to set
     */
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Editar datos del personal.");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(jLabel16, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 114, Short.MAX_VALUE)
    ...
    private void btnNuevo3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevo3ActionPerformed
        lanzarDialogEstudiante(getPersonal());
