 ...
 * @author edrev
 */
public class DLGUsuarioRegistrar extends javax.swing.JDialog {
...
//        persona_.setApellidoPaterno(txtMaterno.getText());
    ...
    private void guardarUsuario() {
        try {
            ...
            if (_txtpass1.isEmpty()) {
                msg = msg + "Escriba una contrase\u00F1a.\n";
            }
            ...
            TaskDialogs.inform(this, "Usuario guardado correctamente", "Se cre\u00f3 un nuevo usuario con los datos proporcionados.");
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/40/icons8-AddUser-40.png"))); // NOI18N
