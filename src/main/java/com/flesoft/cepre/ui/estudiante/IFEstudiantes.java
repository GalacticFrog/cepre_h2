 ...
 * @author user
 */
public class IFEstudiantes extends javax.swing.JInternalFrame {

    /**
     * Creates new form IFEstudiantes
     */
    public IFEstudiantes() {
        initComponents();
        cargarIFEstudiantes();
    }
    ...
    private void initComponents() {
        ...
        pnbActualizarParametros3.setTitle("ESTUDIANTES             ");
        ...
        jLabel6.setText("Listado de estudiantes");
        ...
        jLabel7.setText("Registrar huella");
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        ...
        limpiarFrames();
        BuscaEstudiante demo = new BuscaEstudiante();
//        demo.setParentFrame(this);
    ...
    private void cargarIFEstudiantes() {
        limpiarFrames();

        IFIEstudiantes ifiEsrudiantes = new IFIEstudiantes();
