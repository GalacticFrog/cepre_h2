...
public class DLGImagenHuella extends javax.swing.JDialog {
    ...
    private void guardarImagenHuella(int indice) {
        System.out.println("GUARDANDO HUELLA");
        ...
        if (isdir) {
            System.out.println("EXISTE Y ES ESCRIBIBLE");
            try {
            ...
            System.out.println("NO ACCESIBLE RUTA");
            try {
...
//        ImageUtils.saveTiff(ruta, img);
        System.out.println("path huellas: " + ruta);
        accionCerrarVentana();
    }
