...
public class TableRowUtilities {
     ...
     *
     * @param userTable - Table to have column added to (if it is in a
     * scrollpane)
     * @param startingNumber - Number to start number column with, typically 0
     * or 1.
     */
    ...
    /**
     * Table Model for the row number column. It just has one column (the
     * numbers)
     *
     * @author Oliver Watkins
     */
     ...
     *
     * The reason why this method is important, is that when the row number
     * increases by an extra digit the column needs to get wider. It also needs
     * to shrink when scrolling to smaller digit numbers.
     *
    ...
    /**
     * Listener that joins the two tables; the main table, and the single column
     * row number table. When either are moved or selected, then the affect is
     * passed on to the other table.
     *
     * @author Oliver Watkins
     */
